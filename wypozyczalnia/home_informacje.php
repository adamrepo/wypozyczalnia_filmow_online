	...
	<div class="wrapper">
		...
		<div class="content">
			...
			<?php
				...
				$wyniki_wyszukiwania = $polaczenie->query("select * from uzytkownicy where id_uzytkownika = $id_uzytkownika");
				$r = $wyniki_wyszukiwania->fetch_assoc();
				...
				echo "</div>";	
				echo "<div class='title'>";
					echo "Na stronie od ".$r['data_dolaczenia'];
				echo "</div>";	
