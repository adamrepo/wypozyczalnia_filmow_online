	...
	if (isset($_POST['email']))
	{
		...
		try 
		{
			...
			else
			{
				...
				$rezultat = $polaczenie->query("SELECT login FROM uzytkownicy WHERE email='$email'");
				...
				if ($wszystko_OK==true)
				{
					...
					if ($polaczenie->query("INSERT INTO uzytkownicy (email, login, haslo, data_dolaczenia) VALUES ('$email', '$nick', '$haslo1', now())"))
					{
...
<body>
	...
	<div id="container">
		...
		<form method="post">
			...
			<input type="password" placeholder="powtórz hasło" onfocus="this.placeholder=''" onblur="this.placeholder='hasło'" value="<?php
